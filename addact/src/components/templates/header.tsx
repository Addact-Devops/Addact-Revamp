    ...
    if (subs.length > 0 && anyHasLevel3) {
        ...
        return (
            <div className='flex w-full items-stretch min-h-[336px]'>
                ...
                <div className='flex-1 px-[40px] py-[30px] pb-7 text-white' style={{ background: "#0F0F0F" }}>
                    {hasLevel3 ? (
                        <div className={`grid ${showCard ? "grid-cols-1" : "grid-cols-2"} gap-x-8 gap-y-[28px]`}>
...
const Header = ({
    ...
    const useContactDrawer = !contactIsExternal && shouldOpenContactDrawer(contactHref);
