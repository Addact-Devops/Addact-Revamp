  ...
  return (
    ...
    >
      <div
        className={`bg-gray-300 rounded overflow-hidden ${
          big
            ...
            : "w-full max-w-full lg:max-w-[250px] xl:max-w-[320px] aspect-[320/244] max-h-[244px]"
        }`}
      >
        {item.image?.url && (
          <Image
      ...
      <div className="flex flex-col flex-1 justify-center">
        ...
        <h4 className="lg:!text-base xl:!text-3xl font-medium mb-4 leading-tight line-clamp-2">
          {item.title}
        </h4>
