...
const AccordionRow: FC<AccordionItemProps> = ({ item, isOpen, onToggle, isMobile }) => {
    ...
    return (
        ...
        >
            <div className={`flex items-center gap-3  ${isOpen ? "" : "py-4 md:py-5"}`}>
...
const AIDevelopmentProcess: FC<AIDevelopmentProcessProps> = ({ data }) => {
    ...
    return (
        <section className='w-full bg-[#0F0F0F]'>
            <div className='container-main mx-auto flex flex-col min-h-screen px-6 py-10 md:px-12 md:py-16 lg:px-20! lg:py-24! xl:py-20!'>
