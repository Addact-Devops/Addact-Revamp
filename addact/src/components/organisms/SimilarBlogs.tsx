          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col flex-1 justify-start">
                ...
                <h4 className="md:!text-2xl text-black font-medium mb-4 leading-tight line-clamp-3">
                  {title}
                </h4>
              ...
              <div className="mt-auto self-end">
                <Link
                  href={`/blogs${blog.ReadNow!.href!}`}
                  target="_self"
                  aria-label={`Read blog: ${title}`}
                >
                  <div className="group w-14 h-14 bg-[#3C4CFF] text-black flex items-center justify-center absolute bottom-0 right-0 transition-all duration-300 hover:w-16 hover:h-16">
