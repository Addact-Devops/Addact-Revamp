...
const staticTabs: TechStackTab[] = [
    {
        ...
        title: "Mobile",
        items: [
            { id: "ios-1", label: "iOS", image: { url: createIconDataUrl(), alt: "iOS" } },
            { id: "ios-2", label: "iOS", image: { url: createIconDataUrl(), alt: "iOS" } },
            { id: "ios-3", label: "iOS", image: { url: createIconDataUrl(), alt: "iOS" } },
            { id: "ios-4", label: "iOS", image: { url: createIconDataUrl(), alt: "iOS" } },
        ],
    },
    {
        id: "frontend",
        title: "Frontend",
        items: [
            { id: "react", label: "React", image: { url: createIconDataUrl(), alt: "React" } },
            { id: "next", label: "Next.js", image: { url: createIconDataUrl(), alt: "Next.js" } },
            { id: "vue", label: "Vue", image: { url: createIconDataUrl(), alt: "Vue" } },
            { id: "angular", label: "Angular", image: { url: createIconDataUrl(), alt: "Angular" } },
        ],
    },
    {
        id: "backend",
        title: "Backend",
        items: [
            { id: "node", label: "Node.js", image: { url: createIconDataUrl(), alt: "Node.js" } },
            { id: "dotnet", label: ".NET", image: { url: createIconDataUrl(), alt: ".NET" } },
            { id: "php", label: "PHP", image: { url: createIconDataUrl(), alt: "PHP" } },
            { id: "python", label: "Python", image: { url: createIconDataUrl(), alt: "Python" } },
        ],
    },
    {
        id: "testing",
        title: "Testing",
        items: [
            { id: "jest", label: "Jest", image: { url: createIconDataUrl(), alt: "Jest" } },
            { id: "cypress", label: "Cypress", image: { url: createIconDataUrl(), alt: "Cypress" } },
            {
                id: "playwright",
                label: "Playwright",
                image: { url: createIconDataUrl(), alt: "Playwright" },
            },
            { id: "selenium", label: "Selenium", image: { url: createIconDataUrl(), alt: "Selenium" } },
        ],
    },
    {
        id: "devops",
        title: "Devops",
        items: [
            { id: "docker", label: "Docker", image: { url: createIconDataUrl(), alt: "Docker" } },
            {
                id: "kubernetes",
                label: "Kubernetes",
                image: { url: createIconDataUrl(), alt: "Kubernetes" },
            },
            { id: "aws", label: "AWS", image: { url: createIconDataUrl(), alt: "AWS" } },
            { id: "azure", label: "Azure", image: { url: createIconDataUrl(), alt: "Azure" } },
        ],
    },
    {
        id: "aiml",
        title: "AI/ML",
        items: [
            { id: "openai", label: "OpenAI", image: { url: createIconDataUrl(), alt: "OpenAI" } },
            { id: "langchain", label: "LangChain", image: { url: createIconDataUrl(), alt: "LangChain" } },
            { id: "pytorch", label: "PyTorch", image: { url: createIconDataUrl(), alt: "PyTorch" } },
            {
                id: "tensorflow",
                label: "TensorFlow",
...
const OurTechStack = ({
    ...
    const initialTabId =
        defaultActiveTabId && tabs.some((tab) => tab.id === defaultActiveTabId) ? defaultActiveTabId : tabs[0]?.id;
