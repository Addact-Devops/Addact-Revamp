            ...
            <div className="container">
                <div className="flex flex-col">
                    <div className="flex items-center gap-3">
                        <motion.h2
                            className="border-after !text-[28px] md:!text-[40px] 2xl:!text-[60px] !pb-4 xl:!pb-10 text-black border-black/20"
                    ...
                    {/* Mobile Accordion */}
                    <div className="block sm:hidden mt-8 -mx-6 bg-brand-blue-light/30">
                        {cards.slice(0, 6).map((service: CardItem, index: number) => (
                            ...
                            >
                                <button
                                    ...
                                    className="flex justify-between items-center w-full py-4 px-6 text-left text-black"
                                >
                    ...
                    <section className="hidden sm:block">
                        ...
                        >
                            {cards.slice(0, 6).map((service: CardItem, index: number) => (
                                ...
                                >
                                    <SpotlightCard className="h-full text-black">
                                        <div className="p-4 2xl:p-7 h-full text-black">
                                            ...
                                            <h3 className="text-[25px]! 2xl:text-3xl! mb-4 font-bold text-black">{service?.Title ?? ""}</h3>
                                            <div className="text-[18px] 2xl:text-[20px] text-black">
                                                <RichText
                                                    html={(service?.Description ?? "")
                                                        .toString()
                                                        .replace(/^<p>|<\/p>$/g, "")}
