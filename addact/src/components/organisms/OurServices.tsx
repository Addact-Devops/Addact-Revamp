        ...
        <section>
            <div className="container">
                <div className="flex flex-col">
                    <h2 className="border-after">Our Services</h2>
                    <section>
                        <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-24">
                            {servicesList.map((service, index) => (
                                ...
                                >
                                    ...
                                    <p className="text-base  2xl:text-xl text-white">{service.description}</p>
                                </div>
                            ))}
                        </div>
                    </section>
