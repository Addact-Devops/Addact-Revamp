...
const CostEstimatorForm = () => {
  ...
  const answers = useMemo(() => {
    ...
    if (s1Visible) {
      items.push({
        ...
        text: sitecoreVersion,
      });
      items.push({
        id: `${String(id++).padStart(2, "0")}.`,
        text: sitecoreProduct,
      });
      items.push({
        id: `${String(id++).padStart(2, "0")}.`,
        text:
  ...
  const trySubmit = async () => {
    ...
    const formattedAnswers = [
      ...
      {
        label: "Sub Website",
        value: hasSubsites ? subsiteCount || "Yes" : "No",
      },
      { label: "Language Support", value: languageCount || "N/A" },
      {
        label: "Custom Modules",
        value: hasCustom ? customCount || "Yes" : "No",
      },
      {
        label: "Hosting Provider",
        value: hostingProvider === "Other" ? hostingOther : hostingProvider,
      },
      {
        label: "Personalization Rule",
        value: usePersonalization ? "Yes" : "No",
      },
      {
        label: "Accessibility Standards",
        value: needsAccessibility ? "Yes" : "No",
      },
  ...
  return (
    <div className="py-[50px] md:py-[70px] lg:py-[100px] bg-black">
      <div className="container-main xl:flex md:gap-[15px] xl:gap-[24px] items-start">
        {/* Left Panel */}
      ...
      {showExpertModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-[10px] flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-[10px] shadow-lg p-[30px] xl:p-[40px] 2xl:p-[60px] max-w-[500px] 2xl:max-w-[640px] w-full">
            ...
            {/* Heading */}
            <h3 className="text-[#23272A] !font-[900] mb-[15px] md:mb-[24px]">
              Contact Our Experts!
            </h3>
            ...
            <p className="text-gray-700 text-sm md:text-base mb-6 leading-relaxed">
              ...
              <b className="mt-3 block">
                ...
                <a
                  ...
                  className="text-[#3C4CFF] font-semibold hover:underline"
                >
                  +91 94277 22717
                </a>
              </b>
