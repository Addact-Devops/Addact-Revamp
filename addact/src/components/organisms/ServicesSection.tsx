...
export default function ServicesSection({ data }: ServicesSectionProps) {
    const baseListingContext = data?.listingContext;
    ...
    const sectionHeading = baseListingContext?.title || data?.serviceTitle || SECTION_HEADING;
    const sectionDescription = baseListingContext?.description || SECTION_DESCRIPTION;
    const ctaLabel = baseListingContext?.link?.label || CTA_LABEL;
    const ctaHref = baseListingContext?.link?.href || "#";
    const ctaTarget = baseListingContext?.link?.target || "_self";
    const ctaIsExternal = baseListingContext?.link?.isExternal || false;
    return (
        <>
