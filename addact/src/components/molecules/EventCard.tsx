            ...
            <div className="md:w-2/3 px-3 py-2 w-full flex flex-col justify-between">
                <div className="space-y-2">
                    ...
                    {date && (
                        <div className="flex font-medium items-center gap-2 text-base text-white">
                            <CalendarDays size={18} className="text-[#3C4CFF]" />
                            <span>{date}</span>
                        </div>
                    )}
                ...
                <div className="mt-4">
                    <Link
                        ...
                        className="inline-flex items-center px-6 py-3 bg-[#3C4CFF] font-medium text-white !text-base rounded-full transition hover:bg-[#3440CB]"
                    >
