...
import { getDevelopmentDesignSlug, DevelopmentDesignDetail } from "@/graphql/queries/getDevelopmentDesignSlug";
import { CmsDetail, getDevelopmentDesignDetailsCmsSlug } from "@/graphql/queries/getDevelopmentDesignCmsSlug";
import {
    SitecoreDetail,
...
const SiteDetailClient = ({ data }: { data: PageData }) => {
    ...
    console.log("🚀 ~ SiteDetailClient ~ bannerData:", bannerData);
