...
export default function StaticContactUs() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            const payload = {
                ...
                pageTitle,
                recipientEmails: ["info@addact.net"], // 🔹 static instead of dynamic
            };

            const res = await fetch("/api/hire-certified-sitecore-developer", {
                method: "POST",
                headers: {
            ...
            <div className="container mx-auto border border-gray-700 overflow-hidden !p-0">
                <div className="flex flex-col justify-between">
                    ...
                    <div className="w-full flex flex-col md:flex-row md:items-center md:justify-between pb-[30px] md:pb-0">
                        ...
                        <div className="md:w-[70%] text-white px-5 pb-5 md:px-16">
                            <p className="font-light text-base md:!text-3xl md:!leading-[54px]">
                                Share your needs we’ll help you get the right Sitecore developer.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-stretch justify-center">
                        ...
                        <div className="hidden lg:block w-1/2 relative">
                            <Image
                                src="https://d3l7d9gtq0bnch.cloudfront.net/image_15_ee1c993aad.png"
                                alt="Contact"
                                fill
