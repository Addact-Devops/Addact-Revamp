...
const faqs = [
  {
    ...
    answer:
      "Addact provides certified Sitecore developers with proven project experience and strong platform knowledge. We focus on agility, scalability, and delivering enterprise value through tailored development services.",
  },
  {
    question: "Do your Sitecore developers work with XM Cloud and Sitecore XP?",
    answer:
      "Yes, our developers are trained and experienced with the latest Sitecore products, including XM Cloud, XP, SXA, and CDP integrations.",
  },
  {
    question:
      "Can I scale the number of Sitecore developers during my project?",
    answer:
      "Absolutely. Our hiring model is flexible—scale your team up or down based on project phases, timelines, and business goals.",
  },
  {
    question: "How does Addact ensure code quality and performance?",
    answer:
      "We follow Sitecore coding standards, version control, CI/CD practices, and performance benchmarking to ensure high-quality, maintainable code.",
  },
  {
    question: "What level of support do you offer post-deployment?",
    answer:
      "Our developers provide continuous monitoring, updates, enhancements, and troubleshooting to ensure your Sitecore website stays optimized and secure.",
  },
  {
    question: "How fast can I hire a Sitecore developer from Addact?",
    answer:
      "You can start the hiring process immediately. After understanding your requirements, we share relevant CVs within 24–48 hours and begin onboarding in just a few days.",
  },
];
...
export default function SiteDetailClient() {
  ...
  useEffect(() => {
    const stored =
      ...
      sessionStorage.getItem("faq-open-static");
    if (stored) {
    ...
    <>
      <main className="bg-dark">
        <header className="fixed top-0 w-full z-50 bg-[#0F0F0F] shadow-[0_4px_12px_rgba(60,76,255,0.25)]">
          <div className="container-main mx-auto flex justify-center items-center py-[20px] xl:py-[30px]">
            <Image
        ...
        <section className="relative text-white overflow-hidden">
          ...
          <div className="relative container-main mt-[68px] md:mt-[120px] min-h-[550px] 2xl:min-h-[659px] flex flex-col lg:justify-center justify-end h-full mb-[40px] lg:mb-0">
            <div className="text-left max-w-[95%]">
              ...
              <div className="text-white text-[15px] leading-[25px] lg:text-[17px] lg:leading-[30px] font-normal mt-0 lg:max-w-[50%]">
                Trusted Sitecore developers from the USA who combine platform
                expertise and agility to enhance your digital experiences.
              </div>
              <div className="mt-10">
                <button
                  onClick={() => {
                  ...
                  <>
                    ...
                    <div className="hidden md:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                      <div className="group relative md:bg-[#1C1C1C] border-l-[5px] border-[#3C4CFF] sm:p-8 p-[20px]">
                        ...
                        <p>
                          Build personalized, scalable, and high-performing
                          digital platforms and get custom Sitecore
                          implementations, component development, and
                          optimization.
                        </p>
                      </div>
                      <div className="group relative md:bg-[#1C1C1C] border-l-[5px] border-[#3C4CFF] sm:p-8 p-[20px]">
                        ...
                        <p>
                          Seamlessly migrate from legacy platforms to Sitecore
                          and ensure structured planning, zero data loss, and
                          full compatibility with your digital ecosystem.
                        </p>
                      </div>
                      <div className="group relative md:bg-[#1C1C1C] border-l-[5px] border-[#3C4CFF] sm:p-8 p-[20px]">
                        <h3 className="text-white !text-[20px] md:!text-[30px] mb-6">
                        ...
                        <p>
                          From upgrades and monitoring to proactive issue
                          resolution, our managed Sitecore services help keep
                          your platform optimized and secure at all times.
                        </p>
                      </div>
                      <div className="group relative md:bg-[#1C1C1C] border-l-[5px] border-[#3C4CFF] sm:p-8 p-[20px]">
                        <h3 className="text-white !text-[20px] md:!text-[30px] mb-6">
                        ...
                        <p>
                          Our post-launch support covering bug fixes,
                          enhancements, updates, and ongoing performance tuning
                          to keep your platform stable and future ready.
                        </p>
                      </div>
                      <div className="group relative md:bg-[#1C1C1C] border-l-[5px] border-[#3C4CFF] sm:p-8 p-[20px]">
                        <h3 className="text-white !text-[20px] md:!text-[30px] mb-6">
                        ...
                        <p>
                          ...
                          downtime, ensuring security, features, and
                          scalability.
                        </p>
                      </div>
                      <div className="group relative md:bg-[#1C1C1C] border-l-[5px] border-[#3C4CFF] sm:p-8 p-[20px]">
                        ...
                        <p>
                          ...
                          MarTech platforms and create unified, omnichannel
                          ecosystems for data-driven decisions.
                        </p>
                      </div>
                    </div>
                      ...
                      <Slider {...sliderSettings}>
                        <div className="space-y-[16px]">
                          ...
                          <div className="relative group bg-[#1C1C1C] border-l-[3px] border-[#3C4CFF] p-[16px]">
                            ...
                            <p>
                              Seamlessly migrate from legacy platforms to
                              Sitecore and ensure structured planning, zero data
                              loss, and full compatibility with your digital
                              ecosystem.
                            </p>
                          </div>
                        </div>
                        <div className="space-y-[16px]">
                          <div className="relative group bg-[#1C1C1C] border-l-[3px] border-[#3C4CFF] p-[16px]">
                            ...
                            <p>
                              From upgrades and monitoring to proactive issue
                              resolution, our managed Sitecore services help
                              keep your platform optimized and secure at all
                              times.
                            </p>
                          </div>
                          <div className="relative group bg-[#1C1C1C] border-l-[3px] border-[#3C4CFF] p-[16px]">
                            ...
                            <p>
                              Our post-launch support covering bug fixes,
                              enhancements, updates, and ongoing performance
                              tuning to keep your platform stable and future
                              ready.
                            </p>
                          </div>
                        </div>
                        <div className="space-y-[16px]">
                          <div className="relative group bg-[#1C1C1C] border-l-[3px] border-[#3C4CFF] p-[16px]">
                            ...
                            <p>
                              Upgrade to the latest Sitecore versions and manage
                              the upgrade path end-to-end with careful planning
                              and zero downtime, ensuring security, features,
                              and scalability.
                            </p>
                          </div>
                          <div className="relative group bg-[#1C1C1C] border-l-[3px] border-[#3C4CFF] p-[16px]">
                            ...
                            <p>
                              Integrate Sitecore with your CRM, ERP, analytics,
                              and MarTech platforms and create unified,
                              omnichannel ecosystems for data-driven decisions.
                            </p>
                          </div>
                        </div>
                      </Slider>
                ...
                {activeTab === "hiring" && (
                  <>
                    <p className="text-center max-w-3xl mx-auto text-sm text-gray-300 mb-14 hidden md:block">
                      We offer multiple hiring models to give you the
                      flexibility, control, and scalability you need. Looking
                      for a dedicated Sitecore developer for a long-term
                      engagement or need expert assistance for a shorter phase,
                      hire Sitecore developer now.{" "}
                    </p>
                    ...
                    <div className="hidden md:grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-[#1C1C1C] p-[20px] border border-[#FFFFFF33]">
                        ...
                        <p>
                          Choose from full-time, part-time, or project-based
                          Sitecore developers tailored to your business needs.
                        </p>
                      ...
                      <div className="bg-[#1C1C1C] p-[20px] border border-[#FFFFFF33]">
                        ...
                        <p>
                          Work with pre-vetted Sitecore experts with proven
                          experience in delivering enterprise-grade solutions.
                        </p>
                      ...
                      <Slider {...sliderSettings}>
                        <div>
                          <div className="bg-[#1C1C1C] p-[16px] border border-[#FFFFFF33]">
                            ...
                            <p>
                              Choose from full-time, part-time, or project-based
                              Sitecore developers tailored to your business
                              needs.
                            </p>
                        ...
                        <div>
                          <div className="bg-[#1C1C1C] p-[16px] border border-[#FFFFFF33]">
                            ...
                            <p>
                              Work with pre-vetted Sitecore experts with proven
                              experience in delivering enterprise-grade
                              solutions.
                            </p>
            ...
            <div className="flex flex-col">
              ...
              <div className="block sm:hidden mt-8 -mx-6 bg-[#1c1c1c]">
                ...
                <div className="border-t border-b border-gray-700">
                  ...
                  {openIndex === 0 && (
                    <div className="pb-4 px-6 text-[16px] text-white">
                      Our Sitecore-certified developers are well-versed with
                      SXA, XM Cloud, CDP, and XP ensuring intelligent, scalable
                      websites that align with your enterprise goals.
                    </div>
                  )}
                </div>
                ...
                <div className="border-b border-gray-700">
                  ...
                  {openIndex === 1 && (
                    <div className="pb-4 px-6 text-[16px] text-white">
                      Get started with 40 hours of free Sitecore consulting. We
                      help you identify the right approach, architecture, and
                      developer resources suited to your objectives.
                    </div>
                  )}
                </div>
                ...
                <div className="border-b border-gray-700">
                  ...
                  {openIndex === 2 && (
                    <div className="pb-4 px-6 text-[16px] text-white">
                      Choose the model that fits dedicated developers, part-time
                      specialists, or an entire Sitecore team. We adapt to your
                ...
                <div className="border-b border-gray-700">
                  ...
                  {openIndex === 3 && (
                    <div className="pb-4 px-6 text-[16px] text-white">
                      Experience transparent communication and real-time
                      collaboration with our developers ensuring complete
                ...
                <div className="border-b border-gray-700">
                  ...
                  {openIndex === 4 && (
                    <div className="pb-4 px-6 text-[16px] text-white">
                      We stay involved beyond deployment with ongoing
                      monitoring, enhancements, bug resolution, and performance
                      optimization.
                    </div>
                  )}
                </div>
                ...
                <div className="border-b border-gray-700">
                  ...
                  {openIndex === 5 && (
                    <div className="pb-4 px-6 text-[16px] text-white">
                      We follow Sitecore best practices, structured QA
                      processes, and secure coding standards to deliver robust,
                      enterprise-grade Sitecore services.
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-10 sm:mt-14 2xl:mt-24">
                  ...
                  <div className="relative">
                    <div className="text-white p-4 2xl:p-7">
                      ...
                      <div className="text-[18px] 2xl:text-[20px] text-white">
                        Our Sitecore-certified developers are well-versed with
                        SXA, XM Cloud, CDP, and XP ensuring intelligent,
                        scalable websites that align with your enterprise goals.
                      </div>
                    </div>
                  ...
                  <div className="relative">
                    <div className="text-white p-4 2xl:p-7">
                      ...
                      <div className="text-[18px] 2xl:text-[20px] text-white">
                        Get started with 40 hours of free Sitecore consulting.
                        We help you identify the right approach, architecture,
                        and developer resources suited to your objectives.
                      </div>
                    </div>
                    <div className="absolute top-1/8 right-0 h-3/4 w-[1px] bg-white opacity-40"></div>
                  </div>
                  ...
                  <div className="relative">
                    <div className="text-white p-4 2xl:p-7">
                      ...
                      <div className="text-[18px] 2xl:text-[20px] text-white">
                        Choose the model that fits dedicated developers,
                        part-time specialists, or an entire Sitecore team. We
                        adapt to your project scope and delivery timeline.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    <div className="text-white p-4 2xl:p-7">
                      ...
                      <div className="text-[18px] 2xl:text-[20px] text-white">
                        We stay involved beyond deployment with ongoing
                        monitoring, enhancements, bug resolution, and
                  ...
                  <div className="relative">
                    <div className="text-white p-4 2xl:p-7">
                      ...
                      <div className="text-[18px] 2xl:text-[20px] text-white">
                        We follow Sitecore best practices, structured QA
                        processes, and secure coding standards to deliver
                        robust, enterprise-grade Sitecore services.
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section data-ref="cta-banner2">
          <div
            ...
            style={{
              backgroundImage:
                'url("https://d3l7d9gtq0bnch.cloudfront.net/CTA_2_30d48f8e3d.png")',
            }}
          >
            <div className="container-main">
              <div className="flex flex-col md:justify-center md:items-center py-[40px] md:py-24 md:text-center">
                <h2 className="!text-[28px] md:!text-[40px] 2xl:!text-[60px] 2xl:leading-[85px]">
                  Deliver Faster. Drive Results. Hire Sitecore Experts from
                  Addact.
                </h2>
                <button
                  onClick={() => {
